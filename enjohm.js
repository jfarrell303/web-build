...
Module['FS_createPath']("/data", "fonts", true, true);
    ...
    loadPackage({"files": [{"filename": "/data/EXPORTING.aseprite", "start": 0, "end": 4110}, {"filename": "/data/back.png", "start": 4110, "end": 7661}, {"filename": "/data/claw.png", "start": 7661, "end": 8742}, {"filename": "/data/fonts/Monaspace.ttf", "start": 8742, "end": 301042}, {"filename": "/data/peng.png", "start": 301042, "end": 464158}, {"filename": "/data/peng_raw.png", "start": 464158, "end": 1640149}, {"filename": "/data/salm.png", "start": 1640149, "end": 1640800}, {"filename": "/data/screendraft.aseprite", "start": 1640800, "end": 1647915}, {"filename": "/data/test.wav", "start": 1647915, "end": 24241055}], "remote_package_size": 24241055});

  })();

// end include: /tmp/tmpm6k2dzs0.js
// include: /tmp/tmp3mar7z67.js

    // All the pre-js content up to here must remain later on, we need to run
    // it.
    if ((typeof ENVIRONMENT_IS_WASM_WORKER != 'undefined' && ENVIRONMENT_IS_WASM_WORKER) || (typeof ENVIRONMENT_IS_PTHREAD != 'undefined' && ENVIRONMENT_IS_PTHREAD) || (typeof ENVIRONMENT_IS_AUDIO_WORKLET != 'undefined' && ENVIRONMENT_IS_AUDIO_WORKLET)) Module['preRun'] = [];
    var necessaryPreJSTasks = Module['preRun'].slice();
  // end include: /tmp/tmp3mar7z67.js
// include: /tmp/tmpt0sovarg.js

    if (!Module['preRun']) throw 'Module.preRun should exist because file support used it; did a pre-js delete it?';
    necessaryPreJSTasks.forEach((task) => {
      if (Module['preRun'].indexOf(task) < 0) throw 'All preRun tasks that exist before user pre-js code should remain after; did you replace Module or modify Module.preRun?';
    });
  // end include: /tmp/tmpt0sovarg.js
