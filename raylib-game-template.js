...
// end include: /tmp/tmp5hjkeftu.js
// include: /tmp/tmpyh1r75qd.js

    // All the pre-js content up to here must remain later on, we need to run
    // it.
    if ((typeof ENVIRONMENT_IS_WASM_WORKER != 'undefined' && ENVIRONMENT_IS_WASM_WORKER) || (typeof ENVIRONMENT_IS_PTHREAD != 'undefined' && ENVIRONMENT_IS_PTHREAD) || (typeof ENVIRONMENT_IS_AUDIO_WORKLET != 'undefined' && ENVIRONMENT_IS_AUDIO_WORKLET)) Module['preRun'] = [];
    var necessaryPreJSTasks = Module['preRun'].slice();
  // end include: /tmp/tmpyh1r75qd.js
// include: /tmp/tmpcv6l6plt.js

    if (!Module['preRun']) throw 'Module.preRun should exist because file support used it; did a pre-js delete it?';
    necessaryPreJSTasks.forEach((task) => {
      if (Module['preRun'].indexOf(task) < 0) throw 'All preRun tasks that exist before user pre-js code should remain after; did you replace Module or modify Module.preRun?';
    });
  // end include: /tmp/tmpcv6l6plt.js
...
function findWasmBinary() {
  return locateFile('raylib-game-template.wasm');
}
...
var ASM_CONSTS = {
  89126: () => { if (document.fullscreenElement) return 1; },  
 89172: () => { return Module.canvas.width; },  
 89204: () => { return parseInt(Module.canvas.style.width); },  
 89252: () => { document.exitFullscreen(); },  
 89279: () => { setTimeout(function(){ Module.requestFullscreen(false, false); }, 100); },  
 89351: () => { if (document.fullscreenElement) return 1; },  
 89397: () => { return Module.canvas.width; },  
 89429: () => { return screen.width; },  
 89454: () => { document.exitFullscreen(); },  
 89481: ($0) => { const canvasId = UTF8ToString($0); setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { document.querySelector(canvasId).style.width="unset"; }, 100); }, 100); },  
 89675: () => { return window.innerWidth; },  
 89701: () => { return window.innerHeight; },  
 89728: () => { if (document.fullscreenElement) return 1; },  
 89774: () => { return Module.canvas.width; },  
 89806: () => { return parseInt(Module.canvas.style.width); },  
 89854: () => { if (document.fullscreenElement) return 1; },  
 89900: () => { return Module.canvas.width; },  
 89932: () => { return screen.width; },  
 89957: () => { return window.innerWidth; },  
 89983: () => { return window.innerHeight; },  
 90010: () => { if (document.fullscreenElement) return 1; },  
 90056: () => { return Module.canvas.width; },  
 90088: () => { return screen.width; },  
 90113: () => { document.exitFullscreen(); },  
 90140: () => { if (document.fullscreenElement) return 1; },  
 90186: () => { return Module.canvas.width; },  
 90218: () => { return parseInt(Module.canvas.style.width); },  
 90266: () => { document.exitFullscreen(); },  
 90293: ($0) => { Module.canvas.style.opacity = $0; },  
 90331: () => { return screen.width; },  
 90356: () => { return screen.height; },  
 90382: () => { return window.screenX; },  
 90409: () => { return window.screenY; },  
 90436: () => { return window.devicePixelRatio; },  
 90472: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 90525: ($0) => { Module.canvas.style.cursor = UTF8ToString($0); },  
 90576: () => { Module.canvas.style.cursor = 'none'; },  
 90613: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 90869: ($0) => { Module.canvas.style.cursor = UTF8ToString($0); },  
 90920: () => { if (document.pointerLockElement) return 1; },  
 90967: () => { if (document.fullscreenElement) return 1; },  
 91013: () => { return window.innerWidth; },  
 91039: () => { return window.innerHeight; }
};
